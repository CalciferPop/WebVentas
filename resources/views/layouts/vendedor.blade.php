...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">APP Ventas : Vendedor </a>
        </div>
            ...
            <li class="dropdown" >
                ...
                <ul class="dropdown-menu dropdown-user" id="menuOpciones">
                    <li class="text-center">
                        <img src="{{asset("images/empleado.png")}}" alt="foto alumno" width="80">
                    </li>
                    <li>
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('clientes_v.create')}}"><i class='fa fa-user-plus fa-fw'></i> Agregar</a>
                            </li>
                            <li>
                                <a href="{{route('clientes_v.index')}}"><i class='fa fa-list-ol fa-fw'></i> ListaClientes</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{{route('empleados_v.index')}}"><i class='fa fa-list-ol fa-fw'></i> Lista Empleados</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{{route('generos_v.index')}}"><i class='fa fa-list-ol fa-fw'></i> Lista Generos</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('pedidos_v.create')}}"><i class='fa fa-plus fa-fw'></i> Agregar</a>
                            </li>
                            <li>
                                <a href="{{route('pedidos_v.index')}}"><i class='fa fa-times  fa-fw'></i> Lista Pedidos Pendientes</a>
                            </li>
                            <li>
                                <a href="{{route('clientes_pedidos_v.index')}}"><i class='fa fa-check  fa-fw'></i> Lista Pedidos Realizados</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('productos_v.index')}}"><i class='fa fa-list-ol fa-fw'></i> Lista Productos</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('roles_v.index')}}"><i class='fa fa-list-ol fa-fw'></i> Lista Roles</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{{route('rutas_v.create')}}"><i class='fa fa-plus fa-fw'></i> Agregar</a>
                            </li>
                            <li>
                                <a href="{{route('rutas_v.index')}}"><i class='fa fa-list-ol fa-fw'></i> Lista Rutas</a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <br><br>
        <div class="panel panel-success">
            <div class="panel-heading">
                <i class="fa fa-user-circle fa-fw"></i>  Detalle Empleado</div>
