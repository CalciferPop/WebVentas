...
@section('contenido')
   ...
   @endif
    ...
    @if(isset($sin_pedidos))
        ...
        <br>
        {!! Form::open(['route' => 'clientes_pedidos_v.store','method' => 'POST','files' => true]) !!}
            ...
            <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <div class="col-lg-8 col-md-6 col-sm-4">
                        ...
                        <a href="{{route('clientes_pedidos_v.destroy',$element['id_pedido'])}}"  ><button type="button" class="btn btn-danger"><i class='fa fa-eraser fa-fw'></i>Eliminar</button></a>
