    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-8 col-md-6 col-sm-4">
                ...
                <a href="{{route('clientes.edit',$element['id_cliente'])}}"  ><button type="button" class="btn btn-success"><i class='fa fa-edit fa-fw'></i>Editar</button></a>
                <a href="{{route('clientes.destroy',$element['id_cliente'])}}" ><button type="button" class="btn btn-danger"><i class='fa fa-eraser fa-fw'></i>Eliminar</button></a>
                <a href="{{route('clientes_pedidos.show',$element['id_cliente'])}}" ><button type="button" class="btn btn-primary"><i class='fa fa-shopping-cart fa-fw'></i>Pedidos Pendientes</button></a>
                <a href="{{route('clientes_pedidos_2.show',$element['id_cliente'])}}" ><button type="button" class="btn btn-success"><i class='fa fa-cart-arrow-down  fa-fw'></i>Pedidos Realizados</button></a>
