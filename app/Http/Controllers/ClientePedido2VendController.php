...
class ClientePedido2VendController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if(empty($clientes_pedidos)){
            ...
            if ($clientes_pedidos == null){
                return view('cliente_pedido2_vend.list_clientes_pedidos')->with('sin_pedidos','Este cliente no tiene ningun pedido realizado');

            }else{
                return view('cliente_pedido2_vend.list_clientes_pedidos',compact('clientes_pedidos'));
