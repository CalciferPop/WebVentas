...
class ClientePedidoController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($pedidos==null){
            return view('pedido.list_pedidos2')
    ...
    return	$result;
        ...
        if ($clientes_pedidos == null){
            return view('cliente_pedido.list_clientes_pedidos')
            ...
            return view('cliente_pedido.list_clientes_pedidos',compact('clientes_pedidos'));
    ...
    public function show($id)
    {
        ...
        if ($clientes_pedidos == null){
            return view('cliente_pedido.list_clientes_pedidos')->with('sin_pedidos','Este cliente no tiene ningun pedido pendiente');
        ...
        //dd($clientes_pedidos);
        //dd ($clientes_pedidos['pedido2'][0]['domicilio']);
        //  die();
